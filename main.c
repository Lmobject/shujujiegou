 ...
 *           1  空链, 无数据
 *           2  已加载蔬菜种类信息数据，无蔬菜基本信息和菜农种植信息数据
 *           4 已加载蔬菜种类信息和蔬菜基本信息数据，无菜农种植信息数据
 *           8 三类基础数据都已加载
16
 *
 * 调用说明:
...
/**
 * 函数名称: Savedata
 * 函数功能: 执行数据保存，将蔬菜种类、基本信息、种植信息三级链表分别存在三个.
 * 输入参数:
 *
 * 输出参数: 无
 * 返 回 值: BOOL类型, TRUE 或 FALSE
...
/**
 * 函数名称: Backupdata
 * 函数功能: 执行数据备份，将蔬菜种类、基本信息、种植信息三类基础数据备份到一个数据文件中.
 * 输入参数:
 *
 * 输出参数: 无
 * 返 回 值: BOOL类型, TRUE 或 FALSE
...
BOOL AboutSys(void)
{
    ...
    if(ChooseModule(plabel_choose)){  //开启浏览器
        system("explorer https://github.com/yifaanleo");
    }
